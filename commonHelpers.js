...
</li>`,"");o.galleryRef.insertAdjacentHTML("beforeend",s)},m="41747369-46a857856bf510ac3748d6666",y=async a=>{try{return(await d.get("https://pixabay.com/api/",{params:a})).data}catch{}},g=a=>{let s=1;const n=40;let t=!1;return async()=>{try{if(t)return;const e={key:m,q:a,image_type:"photo",orientation:"horizontal",safesearch:!0,page:s,per_page:n},{hits:r,totalHits:i}=await y(e);return o.loadMoreBtnRef.style.display="block",r.length===0?(o.loadMoreBtnRef.style.display="none",o.spanLoaderRef.classList.remove("loader"),c.error({position:"topRight",message:"Sorry, there are no images matching your search query. Please try again!"})):s>=Math.ceil(i/n)&&(t=!0,o.loadMoreBtnRef.style.display="none",c.info({position:"topRight",message:"We're sorry, but you've reached the end of search results."})),s+=1,o.searchFormRef.reset(),r}catch{}}};let l=null;const h=async a=>{a.preventDefault(),o.spanLoaderRef.classList.add("loader"),l!=null&&o.loadMoreBtnRef.removeEventListener("click",l);const n=new FormData(a.currentTarget).get("query").trim();o.galleryRef.innerHTML="";const t=g(n);l=async()=>{o.loadMoreBtnRef.style.display="none",o.spanLoaderRef.classList.add("loader");const e=await t();o.spanLoaderRef.classList.remove("loader");const r=new f(".gallery a",{nav:!0,captionDelay:250,captionsData:"alt",close:!0,enableKeyboard:!0,docClose:!0,scrollZoom:!1,fadeSpeed:400});u(e),r.refresh(),p()},await l(),o.spanLoaderRef.classList.remove("loader"),o.loadMoreBtnRef.addEventListener("click",l)};o.searchFormRef.addEventListener("submit",h);
